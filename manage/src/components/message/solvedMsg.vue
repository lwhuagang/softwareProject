    ...
    <div>
        ...
        <el-card>
            ...
            <el-table :data="msgList" border style="width: 100%">
                ...
                <el-table-column prop="message" label="用户反馈">
                </el-table-column>
                <el-table-column prop="result" label="处理记录">
                </el-table-column>
<!--                <el-table-column prop="index" label="操作">-->
<!--                    <template slot-scope="scope">-->
<!--                        &lt;!&ndash;                        <el-button type="primary" icon="el-icon-edit" size="mini" @click="editUserlist(scope.row)"></el-button>&ndash;&gt;-->
